...
function showLoading() {
    ...
    weatherInfo.innerHTML = '<p class="text-gray-500">Loading...</p>';
}
...
function displayWeather(data) {
    ...
    if (description.includes('clouds')) {
        ...
        backgroundImage = 'url(https://images.pexels.com/photos/7002970/pexels-photo-7002970.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)';
    } else {
    ...
    weatherInfo.innerHTML = `
        ...
        <div class="mt-2 grid grid-rows-2 grid-flow-col gap-4">
            ...
            <i class="fa-solid fa-wind"> ${windSpeed} m/s</i>
        </div>
    `;
}
...
// Add debounce to the input field
let debounceTimeout;
document.getElementById('locationInput').addEventListener('input', () => {
    clearTimeout(debounceTimeout);
    debounceTimeout = setTimeout(fetchWeather, 300);
});
